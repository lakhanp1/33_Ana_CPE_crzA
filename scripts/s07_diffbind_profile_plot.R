...
file_diffbindRes <- paste(outDir, "/crzA_diffbind.annotation.filtered.tab", sep = "")
...
diffbindFactors <- intersect(c("up", "noDiff", "down"), peakDiffAn$diffBind)
...
matList <- import_profiles(
  exptInfo = exptData, selectGenes = diffGr$name,
